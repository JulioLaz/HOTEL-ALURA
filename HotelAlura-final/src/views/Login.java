...
public class Login extends JFrame {
	...
	private void Login() throws SQLException{ 
	    con = factory.recuperaConexion(); 
            String usuario=txtUsuario.getText(),contrasena=null;
            if (con!=null){
                UsuariosDAO controller = new UsuariosDAO();
                contrasena = controller.getUsuario(usuario);
//                System.out.println("Cerrando la coneccion: "+contrasena);
                con.close(); 
            }

	        String contrase=new String(txtContrasena.getPassword());
             if (contrasena!= null){       
	        if(contrase.equals(contrasena)){
